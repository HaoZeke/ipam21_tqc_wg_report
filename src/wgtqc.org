...
(cite:dewarLCAOMOTheory1971 demonstrates this pedagogically for $H₂$). The LCAO
...
This neglects both static and dynamic correlations.
...
traced back to the original sin of Gaussian becoming closed source. Lately,
